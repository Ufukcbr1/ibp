        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <a href="{{route('admin_game_add')}}"><button type="button" style="width:120px " class="btn btn-block btn-primary btn-lg">Game Add</button></a>
                    ...
                    <div class="card">
                        ...
                        <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6"></div><div class="col-sm-12 col-md-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable dtr-inline" aria-describedby="example2_info">
                                        ...
                                        <tr>
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Detail</th>
                                        ...
                                        @foreach($datalist as $rs)
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td>{{$rs->price}}</td>
                                                <td>{{$rs->detail}}</td>
                                                <td><a href="{{route('admin_game_delete',['id'=>$rs->id])}}" onclick="return confirm('Delete!Are you sure ?')"><button type="button" style="width:120px " class="btn btn-block btn-primary btn-lg">Delete</button></a></td>
                                            </tr>
                                            </tbody>
                                        @endforeach
